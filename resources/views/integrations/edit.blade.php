        ...
        <div class="row mt-2">
            <div class="col-12">
                <div class="formulario">
                    ...
                    <form action="{{ route('update.integrations', $integration->id) }}" method="POST" class="row row-gap-3">
                        @csrf  
                        ...
                        <div class="submit-field d-flex justify-content-end align-items-center gap-3">
                            <a href="{{ route('index.integrations') }}"> <i class="bi bi-arrow-left px-2"></i>Voltar</a>
