                        ...
                        var data = [
                            @foreach($pipelines as $pipeline)
                                { 
                                    ...
                                    'integration': '{{ $pipeline->statusCode == 1 ? "Disparo de e-mail" : ($pipeline->statusCode == 2 ? "Google Sheets" : ( $pipeline->RelationIntegrations ? $pipeline->RelationIntegrations->name : "" ))}}',
