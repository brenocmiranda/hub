                        ...
                        var data = [
                            @foreach($users as $user)
                                { 
                                    ...
                                    'function': '{{ ucfirst($user->RelationRules->name) }}', 
