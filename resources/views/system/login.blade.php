            ...
            <div class="col-xl-9 col-lg-12 col-11">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-8 col-sm-7 col-12 text-sm-end text-center px-0">
                        ...
                        <a href="https://drive.google.com/file/d/144pvmzqW4E5xt6-AG1bt7cPPRyhx88Zz/view?usp=drive_link" target="_blank" class="btn btn-sm btn-outline-gray rounded-3 border-0 px-3"> <small>Documentação API</small> </a>
                        <a href="mailto:brenodecarvalhomiranda@gmail.com" target="_blank" class="btn btn-sm btn-outline-gray rounded-3 border-0 px-3"> <small>Ajuda</small> </a>
                    </div>
                </div>
            </div>
        </div>
