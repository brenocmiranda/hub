    ...
    <div class="container">
        <div class="row gap-3 justify-content-center">
            <div class="col-xl-8 col-lg-9 col-md-10 col-12 text-center">
                ...
                <h2 class="text-body-tertiary fw-bold">Veja todas as novidades</h2>
                        ...
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse1" aria-expanded="false" aria-controls="flush-collapse1">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <span class="fw-semibold">Meta Ads <span class="badge text-bg-success mx-2">New</span></span>
                                </div>
                            </button>
                        </h2>
                        ...
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse3" aria-expanded="false" aria-controls="flush-collapse3">
                                <div class="d-flex flex-wrap">
                                    <span>15/05/2025</span>
                                    <span class="mx-2">-</span>
                                    <span class="fw-semibold">Conversão de nomenclaturas <small class="badge text-bg-success mx-2">New</small></span>
                                </div>
                            </button>
                        </h2>
