jQuery( function( $ ){
	...
	*/
    ...
    if( window.useColorboxVideo ) { 
        setTimeout(() => {
			if( !$().colorbox ){
				hub.helpers.loadscript( 'https://hub.klash.com.br/js/assets/external/colorbox.min.js', { defer: true }, function(){
    ...
    if( window.galleryJson ) {
		setTimeout(() => {
			...
			if( !$().slick && !!$().colorbox ){
				hub.helpers.loadscript( 'https://hub.klash.com.br/js/assets/external/slick.min.js', { defer: true }, function(){
