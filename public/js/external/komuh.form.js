        ...
        integrations: {
            ...
            send: function( data ){
                return new Promise((resolve, reject) => {
                    let $mail_data = data;
                    let company = window.company || '9e11ff12-35ca-4f8b-ac4e-84e40ca03ca6';

                    $.ajax({
                        url: 'https://hub.komuh.com/api/leads/' + company,
                        type: 'POST',
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader('Authorization', 'Bearer 3|sVcDIgHINt0QC4ZtQd7Z1xSSZjpI9fQsZGTQTcAua77034e6');
                        },
                        data: $mail_data,
            ...
            renderEstagioDeObra: async function ($seletor, estagioDeObra) {
                ...
                if ($data.status) {
                    ...
                    if (video) {
                        const $html = `
                            <div class="wrap">
                                <h2>Mais um empreendimento do <strong>Grupo ${estagioDeObra.empresa.toUpperCase()}</strong>, com inovação, qualidade e sustentabilidade.</h2>
