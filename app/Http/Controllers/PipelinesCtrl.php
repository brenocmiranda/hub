...
class PipelinesCtrl
{
    ...
    public function show(string $id)
    {
        ...
        UsersLogs::create([
            ...
            'description' => 'Foi realizada a visualização das informações da pipeline ' . Pipelines::find($id)->RelationIntegrations->name . ' do lead ' . Pipelines::find($id)->RelationLeads->name . '.',
            'action' => 'show',
